...
function displayScore() {
    $(document).find(".quizcontainer > .results").text("You scored: " + correctAnswers + " out of: " + questions.length);
    $(document).find(".quizcontainer > .results").show();
}

function hideScore() {
    $(document).find(".results").hide();
}
